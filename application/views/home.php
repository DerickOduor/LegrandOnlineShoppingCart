...
<body>
    ...
    <div class="container main">
      ...
      if(empty($res)){
        ...
        <?php
        echo'<div class="row"><legend><a href="http://localhost/legrand/home/category/Phone">Phones</a></legend>';
        foreach($res as $r){
          if($r->tag=='Phone'){
        ...
        echo'</div>';
        echo'<div class="row"><legend><a href="http://localhost/legrand/home/category/Laptop">Laptops</a></legend>';
        foreach($res as $r){
          if($r->tag=='Laptop'){
            echo'<div class="col-md-2 col-sm-6 col-xs-12 item"><div class="name"><a href="http://localhost/leGrand/index.php/home/view_product/'.$r->id.'">'.$r->name.'</a></div><div><a href="http://localhost/leGrand/index.php/home/view_product/'.$r->id.'">'.img(array('max-width'=>'100%','height'=>'80px','class'=>'img rounded mx-auto d-block','src'=>'images/'.$r->picture)).'</a></div><div style="color:red"><b>Kes.'.$r->price.'</b></div><div><a href="http://localhost/LeGrand/index.php/home/view_product/'.$r->id.'"><button class="btn btn-success buy_btn"><span class="glyphicon glyphicon-shopping-cart"></span>&nbsp;Buy</button></a></div></div>';
          }
        ...
        echo'</div>';
        echo'<div class="row"><legend><a href="http://localhost/legrand/home/category/Computers">Computers</a></legend>';
        foreach($res as $r){
          if($r->tag=='Computers'){
            echo'<div class="col-md-2 col-sm-6 col-xs-12 item"><div class="name"><a href="http://localhost/leGrand/index.php/home/view_product/'.$r->id.'">'.$r->name.'</a></div><div><a href="http://localhost/leGrand/index.php/home/view_product/'.$r->id.'">'.img(array('max-width'=>'100%','height'=>'80px','class'=>'img rounded mx-auto d-block','src'=>'images/'.$r->picture)).'</a></div><div style="color:red"><b>Kes.'.$r->price.'</b></div><div><a href="http://localhost/LeGrand/index.php/home/view_product/'.$r->id.'"><button class="btn btn-success buy_btn"><span class="glyphicon glyphicon-shopping-cart"></span>&nbsp;Buy</button></a></div></div>';
          }
        ...
        echo'</div>';
        echo'<div class="row"><legend><a href="http://localhost/legrand/home/category/Television">Television</a></legend>';
        foreach($res as $r){
          if($r->tag=='Television'){
            echo'<div class="col-md-2 col-sm-6 col-xs-12 item"><div class="name"><a href="http://localhost/leGrand/index.php/home/view_product/'.$r->id.'">'.$r->name.'</a></div><div><a href="http://localhost/leGrand/index.php/home/view_product/'.$r->id.'">'.img(array('max-width'=>'100%','height'=>'80px','class'=>'img rounded mx-auto d-block','src'=>'images/'.$r->picture)).'</a></div><div style="color:red"><b>Kes.'.$r->price.'</b></div><div><a href="http://localhost/LeGrand/index.php/home/view_product/'.$r->id.'"><button class="btn btn-success buy_btn"><span class="glyphicon glyphicon-shopping-cart"></span>&nbsp;Buy</button></a></div></div>';
          }
        ...
        echo'</div>';
        echo'<div class="row"><legend><a href="http://localhost/legrand/home/category/Shoes">Shoes</a></legend>';
        foreach($res as $r){
          if($r->tag=='Shoes'){
            echo'<div class="col-md-2 col-sm-6 col-xs-12 item"><div class="name"><a href="http://localhost/leGrand/index.php/home/view_product/'.$r->id.'">'.$r->name.'</a></div><div><a href="http://localhost/leGrand/index.php/home/view_product/'.$r->id.'">'.img(array('max-width'=>'100%','height'=>'80px','class'=>'img rounded mx-auto d-block','src'=>'images/'.$r->picture)).'</a></div><div style="color:red"><b>Kes.'.$r->price.'</b></div><div><a href="http://localhost/LeGrand/index.php/home/view_product/'.$r->id.'"><button class="btn btn-success buy_btn"><span class="glyphicon glyphicon-shopping-cart"></span>&nbsp;Buy</button></a></div></div>';
          }
        ...
        echo'</div>';
        echo'<div class="row"><legend><a href="http://localhost/legrand/home/category/Shirts">Shirts</a></legend>';
        foreach($res as $r){
          if($r->tag=='Shirts'){
            echo'<div class="col-md-2 col-sm-6 col-xs-12 item"><div class="name"><a href="http://localhost/leGrand/index.php/home/view_product/'.$r->id.'">'.$r->name.'</a></div><div><a href="http://localhost/leGrand/index.php/home/view_product/'.$r->id.'">'.img(array('max-width'=>'100%','height'=>'80px','class'=>'img rounded mx-auto d-block','src'=>'images/'.$r->picture)).'</a></div><div style="color:red"><b>Kes.'.$r->price.'</b></div><div><a href="http://localhost/LeGrand/index.php/home/view_product/'.$r->id.'"><button class="btn btn-success buy_btn"><span class="glyphicon glyphicon-shopping-cart"></span>&nbsp;Buy</button></a></div></div>';
          }
        ...
        echo'</div>';
        echo'<div class="row"><legend><a href="http://localhost/legrand/home/category/Sweaters">Sweaters</a></legend>';
        foreach($res as $r){
          if($r->tag=='Sweaters'){
            echo'<div class="col-md-2 col-sm-6 col-xs-12 item"><div class="name"><a href="http://localhost/leGrand/index.php/home/view_product/'.$r->id.'">'.$r->name.'</a></div><div><a href="http://localhost/leGrand/index.php/home/view_product/'.$r->id.'">'.img(array('max-width'=>'100%','height'=>'80px','class'=>'img rounded mx-auto d-block','src'=>'images/'.$r->picture)).'</a></div><div style="color:red"><b>Kes.'.$r->price.'</b></div><div><a href="http://localhost/LeGrand/index.php/home/view_product/'.$r->id.'"><button class="btn btn-success buy_btn"><span class="glyphicon glyphicon-shopping-cart"></span>&nbsp;Buy</button></a></div></div>';
          }
        ...
        echo'</div>';
        echo'<div class="row"><legend><a href="http://localhost/legrand/home/category/Trousers">Trousers</a></legend>';
        foreach($res as $r){
          if($r->tag=='Trousers'){
            echo'<div class="col-md-2 col-sm-6 col-xs-12 item"><div class="name"><a href="http://localhost/leGrand/index.php/home/view_product/'.$r->id.'">'.$r->name.'</a></div><div><a href="http://localhost/leGrand/index.php/home/view_product/'.$r->id.'">'.img(array('max-width'=>'100%','height'=>'80px','class'=>'img rounded mx-auto d-block','src'=>'images/'.$r->picture)).'</a></div><div style="color:red"><b>Kes.'.$r->price.'</b></div><div><a href="http://localhost/LeGrand/index.php/home/view_product/'.$r->id.'"><button class="btn btn-success buy_btn"><span class="glyphicon glyphicon-shopping-cart"></span>&nbsp;Buy</button></a></div></div>';
          }
