...
<body>
    ...
    <?php 
      ...
      foreach($res as $pi){
          $picture=$pi->picture;
          echo '<p>Edit product: '.$id=$pi->id.'<br/>'.$pi->name.'</p>';
        }
    ?> 
    <div class="row">
    <div class="col-md-6">
        <img src="http://localhost/legrand/index.php/../images/<?php echo $picture?>">
        <?php 
         // img(array('max-width'=>'100%','height'=>'80px','class'=>'img rounded mx-auto d-block','src'=>'images/'.$r->picture));
        ?>
    </div>
    <div class="col-md-6">
      <div class="container">
    <form action="http://localhost/legrand/admin/upload_product_pic_2/<?php echo $id;?>"method="POST"enctype="multipart/form-data"class="form">
      <div class="container">
        Product pic 2
      </div>
    ...
    <div class="container">
    <form action="http://localhost/legrand/admin/upload_product_pic_3/<?php echo $id;?>"method="POST"enctype="multipart/form-data"class="form">
      <div class="container">
        Product pic 3
      </div>
      <div class="form-group">
    ...
    <div class="container">
    <form action="http://localhost/legrand/admin/upload_product_pic_4/<?php echo $id;?>"method="POST"enctype="multipart/form-data"class="form">
      <div class="container">
        Product pic 4
      </div>
      <div class="form-group">
    ...
    <div class="container">
    <form action="http://localhost/legrand/admin/upload_product_pic_5/<?php echo $id;?>"method="POST"enctype="multipart/form-data"class="form">
      <div class="container">
        Product pic 5
      </div>
      <div class="form-group">
